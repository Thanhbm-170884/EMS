                            ...
                            <!- Admin ->
                                ...
                                <!- Employee ->
                                    <c:if test="${sessionScope.role == 'Employee'}">
                                        ...
                                        <a href="${pageContext.request.contextPath}/requests?action=showForm"
                                                        ...
                                                        <div class="sidebar-footer">
                                                            <div class="user-block">
                                                                ...
                                                                <div>
                                                                    <div class="user-name">
                                                                        <%= session.getAttribute("username") !=null ?
                                                                            session.getAttribute("username") : "Manager"
                                                                            %>
                                                                    </div>
                                                                    <div class="user-role">
                                                            ...
                                                            <button class="btn-logout"
                                                                onclick="window.location='${pageContext.request.contextPath}/logout'">Đăng
                                                                xuất
                                                            </button>
                                                        </div>
                </aside>